...
class ResetPinConfirmScreen extends StatefulWidget {
  String code;
  ResetPinConfirmScreen({super.key, required this.code});

  @override
  State<ResetPinConfirmScreen> createState() => _ResetPinConfirmScreenState();
}

class _ResetPinConfirmScreenState extends State<ResetPinConfirmScreen> {
                            ...
                            : DefaultButton(
                                onSubmit: () async {
                                  if (formKey.currentState!.validate()) {
                                    ...
                                    var result = await _userService.resetPin(
                                      code: widget.code,

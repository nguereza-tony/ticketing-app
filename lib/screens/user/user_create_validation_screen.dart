...
import 'package:personal_budget/validators/validation_code_validator.dart';
import 'package:platine_flutter/platine_flutter.dart';
import 'package:platine_flutter/platine_i18n.dart' as platine_i18n;

class UserCreateValidationScreen extends StatefulWidget {
  String email;
  UserCreateValidationScreen({super.key, required this.email});

  @override
  State<UserCreateValidationScreen> createState() =>
      _UserCreateValidationScreenState();
}

class _UserCreateValidationScreenState
    extends State<UserCreateValidationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: getAppHeader(title: t.titles.userCreate),
      body: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppInputFormField(
                      ...
                      validator: (text) =>
                          ValidationCodeValidator.code(text?.trim()),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                                  ...
                                  if (formKey.currentState!.validate()) {
                                    ...
                                    if (result) {
                                      NotificationHelper.success(
                                        t.messages.userValidatedSuccess,
                                        null,
                                        3,
                                      );
                                      if (context.mounted) {
